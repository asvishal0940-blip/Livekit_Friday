...
def plugin_path() -> str:
    # Override for local development/testing: point at a locally built
    # plugin (e.g. .../rust/target/debug/liblivekit_nc_plugin.dylib)
    # instead of the bundled one.
    override = os.environ.get("LK_NC_PLUGIN_PATH")
    if override:
        if not os.path.exists(override):
            raise RuntimeError(f"LK_NC_PLUGIN_PATH is set but does not exist: {override}")
        return override
